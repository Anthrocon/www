...
The loading dock will be open for drive on service starting at noon on Thursday. There will be a staggered entry from 12-3 PM, and the dock is open for any dealer from 3-9 PM Thursday. Vehicles must be off the floor by 9pm on Thursday. The loading dock is open for drop off only from 8 to 11:30 AM on Friday.

**Red Group**
12-1pm \- A01-04; Island 1, 2, 6; Tattoo booths; B01-04; B09-11; C00-L08, Bodega East 01-16; Bodega West 01-10; M00-T05; X01-07; Y01-10

**Blue Group**
1-2pm \- A05-08; Island 3,7; A11-12; B12-14; C09-L16; Bodega East 17-28; Bodega West 11-26; M06-T15; X08-16; Y11-19

**Yellow Group**
2-3pm \- A09-10; Island 4,5; B05-08; E17-L25, Bodega East 29-44; Bodega West 27-36; M16-T21; X17-22; Y20-28

3-9pm \- Any dealer can enter

If your table number crosses over two groups (ie D08-09), your load in time will be the earlier time slot only. In the example of D08-09, you would be able to load in the 12-1pm Red group and not the 1-2pm Blue group.
...
{{< center >}}{{< button relref="final_dealer_map_2026.png" >}}Download 2026 Layout Map{{< /button >}}{{< /center >}}

This year we will be utilizing Garrison Place to control the dock line queue that extends outside of the convention center. You will not be able to turn left in to the dock, you will need to drive up Garrison Place where we will be checking IDs and time slots as appropriate. Please see the image below for a map and more information.

{{< img src="Load_in_Queue.jpg" alt="A diagram of the Anthrocon 2026 Dealers Room where different vendors are located." hint="drawing" link="self" caption="Anthrocon 2026 Dealers Room layout." >}}
...
4. **Parking is not available inside the loading dock.**
